...
my ( $vep_path, $vep_data, $vep_forks, $buffer_size, $any_allele, $online ) = ( "/home/schexy/biosoft/ensembl-vep/ensembl-vep-release-97", "/work2/scbniu/workspace_hexiaoyu/DataBase/vep_humandb/", 4, 5000, 0, 0);
...
my ( $ref_fasta, $filter_vcf ) = ( "/work2/scbniu/workspace_hexiaoyu/DataBase/vep_humandb/homo_sapiens/97_GRCh37/Homo_sapiens.GRCh37.75.dna.primary_assembly.fa", "/work2/scbniu/workspace_hexiaoyu/DataBase/vep_humandb/ExAC_nonTCGA.r0.3.1.sites.vep.vcf.gz" );
...
print "\n\nhexy add here, array length of region_split: ".@regions_split."\n\n";
print "\n\nhexy add here, regions_split is $regions_split[0]\n\n";
print "\n\nhexy add here, array length of uniq_regions: ".@regions."\n\n";
...
print "\n\nhexy add here, regions length: ".@regions_split."\n\n";
my @kk=keys %flanking_bps;
print "\n\nhexy add here: flanking bps length: ".@kk."\n\n";
